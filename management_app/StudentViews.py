...
from management_app.models import CustomUser, Staffs, Courses, Subjects, Admission, Attendance, AttendanceReport, LeaveReportStudent, FeedBackStudent, StudentResult


def student_home(request):
    student_obj = Admission.objects.get(admin=request.user.id)
...
def student_view_attendance(request):
    student = Admission.objects.get(admin=request.user.id) # Getting Logged in Student Data
...
def student_view_attendance_post(request):
    if request.method != "POST":
        ...
        stud_obj = Admission.objects.get(admin=user_obj)
...
def student_profile(request):
    ...
    student = Admission.objects.get(admin=user)
...
def student_profile_update(request):
    if request.method != "POST":
        ...
        try:
            ...
            student = Admission.objects.get(admin=customuser.id)
...
def student_view_result(request):
    student = Admission.objects.get(admin=request.user.id)
