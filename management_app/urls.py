...
urlpatterns = [
    ...
    path('add_doctors/', HodViews.add_doctors, name="add_doctors"),
    path('add_staff_save/', HodViews.add_staff_save, name="add_staff_save"),
    path('manage_doctors/', HodViews.manage_doctors, name="manage_doctors"),
    ...
    path('add_drugs/', HodViews.add_drugs, name="add_drugs"),
    path('add_course_save/', HodViews.add_course_save, name="add_course_save"),
    path('manage_drugs/', HodViews.manage_drugs, name="manage_drugs"),
    ...
    path('manage_labevents/', HodViews.manage_labevents, name="manage_labevents"),
    path('add_labevents/', HodViews.add_labevents, name="add_labevents"),
    ...
    path('manage_admission/', HodViews.manage_admission, name="manage_admission"),
    path('delete_student/<student_id>/', HodViews.delete_student, name="delete_student"),
    path('add_prescription/', HodViews.add_prescription, name="add_prescription"),
    path('add_subject_save/', HodViews.add_subject_save, name="add_subject_save"),
    path('manage_prescription/', HodViews.manage_prescription, name="manage_prescription"),
